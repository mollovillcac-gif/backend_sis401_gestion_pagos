-- Script para actualizar las secuencias de las claves primarias
-- Ejecutar después de insertar datos para sincronizar los valores de secuencia
-- con los últimos IDs insertados en cada tabla

-- Function: public.update_sequence()
-- Actualiza los seriales de todos los eliminados a un valor inicial 0 si no hay campos y si existen al ultimo serial activo
...
-- Ejecutar la función para actualizar todas las secuencias
